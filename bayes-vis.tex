...
problem outlined in \citep{rubin1981, gelman2013bda}. Figure \ref{fig:mcmc_scatter_divs_schools}
...
evidence of a geometric pathology in parameter space. Figure~\ref{fig:mcmc_parcoord_divs_schools}
